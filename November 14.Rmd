...
decision.rules<- 1:4
icd10.codes.3<- c()
for(i in seq_along(decision.rules)){
  im<- get(paste0("fulld.data.episodes_r",i))
  icd10.codes.3<- c(icd10.codes.3,substr(im$first_icd10,1,3),substr(im$first_icd10,1,3))
}
