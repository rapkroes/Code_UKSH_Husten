...
discovery.tool<- function(decision.rule, pandemic="none", dependent.variable, research.question){
  ...
  if(dependent.variable=="diag"){
    ...
    all.diagnoses<- all.diagnoses[!which(all.diagnoses=="1")] #remove presumed typographical error by some practitioner
...
diag.parameters<- list(initial.or.last= "last",type= 1)
discovery.tool(1, dependent.variable = "diag", research.question = "Welche Diagnosen wurden zuletzt gestellt, R1")
discovery.tool(2, dependent.variable = "diag", research.question = "Welche Diagnosen wurden zuletzt gestellt, R2")
