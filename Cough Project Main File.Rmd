...
# no. 32
discovery.tool<- function(decision.rule, agelims=c(1,150), insurance=c("all","GKV","PKV")[1], remove.copd=FALSE, lims.chronic.diseases=c(0,100), pandemic="none", preliminary.diag=c(NA,TRUE,FALSE)[1], AUB=c(NA,TRUE,FALSE)[1], quarter.selection=1:4, month.selection=1:12, selected.years = "all", dependent.variable, research.question){
  ...
  if(dependent.variable=="diag"){
    ...
    #####escalation_antibiotics#####escalation_antibiotics#####escalation_antibiotics#####escalation_antibiotics#####escalation_antibiotics#####escalation_antibiotics#####escalation_antibiotics#####escalation_antibiotics
...
round(prop.table(table(full_r1$no.matches_diag)), 3)
