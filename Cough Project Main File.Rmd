...
full_r1<- cbind(arrange(episodes.stamm_r1,uniPatID),
                arrange(episodes.diag_r1,uniPatID),
                arrange(episodes.labor_r1,uniPatID),
                arrange(episodes.ueberweis_1,uniPatID))
...
full_r2<- cbind(arrange(episodes.stamm_r2,uniPatID),
                arrange(episodes.diag_r2,uniPatID),
                arrange(episodes.labor_r2,uniPatID),
                arrange(episodes.ueberweis_2,uniPatID))
...
# no. 32
discovery.tool<- function(decision.rule, insurance=c("all","GKV","PKV")[1], remove.copd=FALSE, lims.chronic.diseases=c(0,100), pandemic="none", preliminary.diag=c(NA,TRUE,FALSE)[1], AUB=c(NA,TRUE,FALSE)[1], quarter.selection=1:4, month.selection=1:12, dependent.variable, research.question){
  ...
  episodedf<- episodedf|>
    filter(quarter %in% quarter.selection)|>
    filter(month %in% month.selection)
...
discovery.tool(1, dependent.variable = "age", research.question = "Wie alt waren die Patienten, R1")
discovery.tool(2, dependent.variable = "age", research.question = "Wie alt waren die Patienten, R2")
