...
#uncertain diagnosis
check.v.icd10<- function(icd10vec) {
  if (!is.character(icd10vec)) {
    stop("Input vector must be a character vector.")
  }
  out <- ifelse(substr(icd10vec, nchar(icd10vec), nchar(icd10vec)) == "V", 1, 0)
  return(out)
}
