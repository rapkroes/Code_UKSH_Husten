...
selected.lab.descriptions<- read_xlsx("https://github.com/rapkroes/Code_UKSH_Husten/blob/288b25aa745f178d2705d990e5106ad6db320a4d/freitextanalyse.xlsx")
...
icpc.up<- ICPC |>
  select(uniPatID, TG_DateNum, FreitextTyp, icpc2)
...
contains.multiple.entries(icpc.up)
...
episodes<- episode.fun.alt(icpc.up, 21)
```
