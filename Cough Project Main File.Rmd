...
real.data<- TRUE
if(real.data){
  setwd("N:/StudentischeHilfskraefte/_Kroes (Christoph)/Routinedaten/03_Hitze/DB")
names.vec<- c("Diag1","ICPC1","Labor1","Stamm1","Ueberweis3")

for (i in seq(1,length(names.vec))) {
  file.name<- paste0("DB_",names.vec[i],"_v01",".csv")
